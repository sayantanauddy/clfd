...
def train_task(args, task_id, hnet, tnet, node, device):
...
def eval_task(args, task_id, hnet, tnet, node, device):
...
def train_all(args):
    ...
    for task_id in range(num_tasks):
        ...
        hnet, tnet, node = train_task(args, task_id, hnet, tnet, node, device)
